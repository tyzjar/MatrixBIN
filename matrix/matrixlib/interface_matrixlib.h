...
#define	MATRIXLIB_SCALE_NOT_CONFIGURATION					-5 
#define	MATRIXLIB_SCALE_NO_IN_METROLOGICAL_VERIFICATION		-5
#define	MATRIXLIB_EXECUTION_SEQUENCE_ERROR					-6
...
#define	VPI_CALCULATE_WEIGHT			162		// 		(М) Рассчитать вес с учетом линеаризации
